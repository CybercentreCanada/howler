...
| autonomous_systems | [AS](/howler-docs/odm/class/as) | The original client in a session that has changed clients. Collection of connected Internal Protocol routing prefixes | :material-minus-box-outline: Optional | `None` |
...
| geo | [Geo](/howler-docs/odm/class/geo) | The original client in a session that has changed clients. Geo fields can carry data about a specific location related to an event. | :material-minus-box-outline: Optional | `None` |
...
| nat | [Nat](/howler-docs/odm/class/nat) | The original client in a session that has changed clients. Translated NAT sessions (e.g. internal client to internet). | :material-minus-box-outline: Optional | `None` |
