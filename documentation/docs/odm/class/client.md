...
| user | [User](/howler/odm/class/user) | The user fields describe information about the user that is relevant to the event. | :material-minus-box-outline: Optional | `None` |
| original | [OriginalClient](/howler/odm/class/originalclient) | Original Client Data. | :material-minus-box-outline: Optional | `None` |
