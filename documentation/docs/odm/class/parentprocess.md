...
| code_signature | [CodeSignature](/howler-docs/odm/class/codesignature) | Information about binary code signatures. | :material-minus-box-outline: Optional | `None` |
...
| end | Date | The time the process ended. | :material-minus-box-outline: Optional | `None` |
| entity_id | Keyword | OID Hash of the process. | :material-minus-box-outline: Optional | `None` |
| entry_meta | [EntryMeta](/howler-docs/odm/class/entrymeta) | Process Meta Information. | :material-minus-box-outline: Optional | `None` |
...
| hash | [Hashes](/howler-docs/odm/class/hashes) | Hashes, usually file hashes | :material-minus-box-outline: Optional | `None` |
...
| parent | [ParentParentProcess](/howler-docs/odm/class/parentparentprocess) | Information about the parent process. | :material-minus-box-outline: Optional | `None` |
| pe | [PE](/howler-docs/odm/class/pe) | Windows Portable Executable (PE) metadata. | :material-minus-box-outline: Optional | `None` |
