...
from howler.common.logging import JsonFormatter
from howler.common.logging.format import HWL_JSON_FORMAT
...
def json_logger():
    ...
    logger.handlers[0].setFormatter(JsonFormatter(HWL_JSON_FORMAT))
