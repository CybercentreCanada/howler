...
def test_convert_observable_basic():
    ...
    result, warnings = hit_service.convert_observable(data, unique=False)
...
def test_convert_observable_hash_deterministic():
    ...
    result1, _ = hit_service.convert_observable(data1, unique=False)
    result2, _ = hit_service.convert_observable(data2, unique=False)
...
def test_convert_observable_preserves_explicit_hash():
    ...
    result, _ = hit_service.convert_observable(data, unique=False)
...
def test_convert_observable_assigns_random_id():
    ...
    result1, _ = hit_service.convert_observable({**data}, unique=False)
    result2, _ = hit_service.convert_observable({**data}, unique=False)
...
def test_convert_observable_extra_values_raises():
    ...
    with pytest.raises(HowlerValueError, match="invalid parameters"):
        hit_service.convert_observable(data, unique=False, ignore_extra_values=False)
...
def test_convert_observable_extra_values_ignored():
    ...
    result, warnings = hit_service.convert_observable(data, unique=False, ignore_extra_values=True)
...
def test_convert_observable_invalid_type():
    ...
    with pytest.raises((HowlerTypeError, HowlerValueError)):
        hit_service.convert_observable(data, unique=False)


@patch("howler.services.hit_service.exists", return_value="observable")
def test_convert_observable_unique_already_exists(mock_exists):
    ...
    with pytest.raises(ResourceExists, match="already exists"):
        hit_service.convert_observable(data, unique=True)

    mock_exists.assert_called_once()


@patch("howler.services.hit_service.exists", return_value=None)
def test_convert_observable_unique_does_not_exist(mock_exists):
    ...
    result, _ = hit_service.convert_observable(data, unique=True)
...
def test_convert_observable_deprecated_fields(mock_exists):
    ...
    with patch.object(Observable, "flat_fields") as mock_flat_fields:
        ...
        _, warnings = hit_service.convert_observable(data, unique=True, ignore_extra_values=True)
...
def test_create_observable_already_exists(mock_exists):
    ...
    with pytest.raises(ResourceExists, match="already exists"):
        hit_service.create_observable("some_id", observable)
...
def test_create_observable_success(mock_exists, mock_datastore):
    ...
    result = hit_service.create_observable("test_id", observable)
...
def test_create_observable_with_user(mock_exists, mock_datastore):
    ...
    hit_service.create_observable("test_id", observable, user="test_user")
...
def test_create_observable_without_user(mock_exists, mock_datastore):
    ...
    hit_service.create_observable("test_id", observable)
...
def test_create_observable_skip_exists(mock_exists, mock_datastore):
    ...
    hit_service.create_observable("test_id", observable, skip_exists=True)
...
def test_create_observable_increments_counter(mock_exists, mock_datastore):
    ...
    before = hit_service.CREATED_OBSERVABLES._value.get()
    hit_service.create_observable("test_id", observable)
    after = hit_service.CREATED_OBSERVABLES._value.get()
