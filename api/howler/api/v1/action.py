...
@api_login(
    ...
    required_type=["automation_basic", "automation_advanced", "actionrunner_basic", "actionrunner_advanced"],
)
...
@api_login(audit=False, check_xsrf_token=False, required_type=["automation_basic", "automation_advanced"])
...
@api_login(
    audit=False,
    check_xsrf_token=False,
    required_type=["automation_basic", "automation_advanced"],
)
...
@api_login(audit=True, check_xsrf_token=False, required_type=["automation_basic", "automation_advanced"])
