...
from howler.datastore.collection import CREATE_TOKEN, BulkResult, ESCollection
...
@overload
def get_hit(id: str, as_odm: Literal[True], version: Literal[False] = False, user: User | None = None) -> Hit: ...
