        ...
        (pivot.mappings ?? []).map(_mapping => {
          ...
          if (['selector', 'selectors'].includes(_mapping.key!)) {
            ...
            if (Array.isArray(value)) {
              return [
                ...
                value
                  ...
                  .map(val => ({
                    type: config.configuration?.mapping.mapping?.[_mapping.field!] || guessType!(val.toString()),
                    value: val
                  }))
              ];
            }
            ...
            return [
              _mapping.key,
              {
                type: config.configuration?.mapping.mapping?.[_mapping.field!] || guessType!(value.toString()),
                value
              }
            ];
          }
