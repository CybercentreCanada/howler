    ...
    () => [
      {
        ...
        documentation: {
          ...
          fr: "Vérifie l'égalité de la représentation sous forme de chaîne des deux arguments."
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: 'Effectue la comparaison `arg1 && arg2` et retourne le résultat.'
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: 'Effectue la comparaison `!arg` et retourne le résultat.'
        },
        callback: arg => !arg
      },
      {
        ...
        documentation: {
          ...
          fr: "Encadre l'argument donné avec des accolades."
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: 'Joint deux arguments de chaîne avec une chaîne `sep` donnée, ou la chaîne vide par défaut.'
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: "Récupère l'URL fournie et retourne la clé (aplanie) donnée de l'objet JSON retourné. Le résultat doit être au format JSON!"
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: 'Étant donné un identifiant de hit howler, ce helper affiche une carte de hit pour cet identifiant.'
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: "Étant donné un dictionnaire, retourne un tableau d'objets {clé, valeur}."
        },
        callback: obj => {
          if (!isObject(obj)) {
      ...
      },
      {
        keyword: 'parse_json',
        documentation: {
          en: 'Convert JSON string into and object.',
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: "Retourne la clé (aplanie) donnée de l'objet fourni."
        },
      ...
      },
      {
        ...
        documentation: {
          ...
          fr: 'Vérifie si le champ est présent dans la chaîne.'
        },
        callback: (arg1, arg2) => {
...

      {
        ...
        documentation: {
          ...
          fr: "Exécute une action howler en utilisant un identifiant d'action spécifique (depuis l'URL lors de la visualisation de l'action, par exemple yaIKVqiKhWpyCsWdqsE4D)."
        },
