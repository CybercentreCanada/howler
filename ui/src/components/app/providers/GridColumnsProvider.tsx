...
const DEFAULT_GRID_COLUMNS_CONTEXT: GridColumnsContextType = {
  columns: [],
  setColumns: () => missingContext('GridColumnsContext'),
  columnWidths: {},
  setColumnWidth: () => missingContext('GridColumnsContext'),
  columnSources: {},
  syncToStorage: () => missingContext('GridColumnsContext'),
  isReady: false
};

export const GridColumnsContext = createContext<GridColumnsContextType>(DEFAULT_GRID_COLUMNS_CONTEXT);
