...
const ViewsBase: FC = () => {
  ...
  const [type, setType] = useState<'personal' | 'global' | undefined>(
    searchParams.get('type') as 'personal' | 'global' | undefined
  );
      ...
      afterSearch={
        size(views) > 0 ? (
          <Autocomplete
            ...
            options={Object.values(omitBy(views, isNil))}
