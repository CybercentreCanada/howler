...
const mockModifyDocumentation = vi.hoisted(() => vi.fn((md: string) => `notebook:${md.slice(0, 10)}`));
...
import NotebookDocumentation from './NotebookDocumentation';

describe('NotebookDocumentation', () => {
  it('renders transformed notebook markdown', () => {
    render(<NotebookDocumentation />);
