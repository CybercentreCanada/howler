...
La réponse apparaît en JSON dans le panneau de droite. Les erreurs s'affichent sous l'éditeur; corrigez la syntaxe ou la configuration de la requête avant de l'exécuter à nouveau. Faites glisser le séparateur entre l'éditeur et le résultat pour donner plus d'espace à l'un ou l'autre.

Les exemples intégrés servent seulement de point de départ. Remplacez-les par une requête adaptée aux classifications et aux politiques de rétention des données que vous examinez.
